...
// initializing vue and targeting the div with an ID of Story
  ...
  methods: {
    ...
    postStory() {
        ...
        // check if all input fields are empty
           ...
           and push the story input to the stories
          ...
          // push into stories array

          this.stories.unshift({
          firstname: this.stori.firstname,
          lastname: this.stori.lastname,
          username: this.stori.username,
          like: this.stori.like,
          readMore: this.stori.readMore,
          gender: this.stori.gender,
          headline: this.stori.headline,
          message: this.stori.message 
        })
    ...
    // add likes when user clicks like button
